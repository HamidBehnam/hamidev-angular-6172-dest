 ...
 * @type {?}
 */
const VERSION = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["Version"]('8.2.10');
...
let ProjectCreatorComponent = class ProjectCreatorComponent {
    constructor(router) {
        this.router = router;
        this.createSuccess = () => {
...
ProjectCreatorComponent.ctorParameters = () => [
...
let ProjectDetailComponent = class ProjectDetailComponent {
    ...
    ngOnInit() {
        ...
        this.project$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroyed$)).subscribe((project) => this.project = project);
...
let ProjectsListItemComponent = class ProjectsListItemComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".project-list-item-container:hover {\n  background-color: darkgray;\n  cursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let ProjectsComponent = class ProjectsComponent {
    constructor(projectsFacadeService, router) {
    ...
    projectListComponentManager(projectsListComponent) {
        projectsListComponent.projects$ = this.projects$;
    }
    projectDetailComponentManager(projectDetailComponent) {
        ...
        projectDetailComponent.projectUpdated.subscribe((projectMeta) => this.updateProject(projectMeta));
        projectDetailComponent.projectDeleted.subscribe((projectMeta) => this.deleteProject(projectMeta));
        projectDetailComponent.done.subscribe(() => this.projectDetailPageDone());
    }
    projectCreatorComponentManager(projectCreatorComponent) {
        projectCreatorComponent.projectCreated.subscribe((projectMeta) => this.createProject(projectMeta));
    }
    ...
    onActivated(componentReference) {
        this.initializationCore();
...
class LoadProjectSuccessAction {
    constructor(payload) {
        this.payload = payload;
...
class UpdateProjectSuccessAction {
    constructor(payload) {
        this.payload = payload;
...
class CreateProjectSuccessAction {
    constructor(payload) {
        this.payload = payload;
...
class DeleteProjectSuccessAction {
    constructor(payload) {
        this.payload = payload;
...
let ProjectsEffects = class ProjectsEffects {
    constructor(actions$, projectsService, projectsFacadeService) {
        ...
        this.projectsFacadeService = projectsFacadeService;
        this.loadProjectsAction$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_projects_actions__WEBPACK_IMPORTED_MODULE_3__["ProjectsActionTypes"].LoadProjects), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((action) => this.projectsService.loadProjects()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((projects) => new _actions_projects_actions__WEBPACK_IMPORTED_MODULE_3__["LoadProjectsSuccessAction"](projects)))));
        this.loadProjectAction$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_projects_actions__WEBPACK_IMPORTED_MODULE_3__["ProjectsActionTypes"].LoadProject), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((action) => this.projectsService.loadProject(action.payload)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((project) => new _actions_projects_actions__WEBPACK_IMPORTED_MODULE_3__["LoadProjectSuccessAction"](project)))));
        this.updateProjectAction$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_projects_actions__WEBPACK_IMPORTED_MODULE_3__["ProjectsActionTypes"].UpdateProject), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((action) => this.projectsService.updateProject(action.payload)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((project) => {
        ...
        //   ))
        // );
        this.createProjectAction$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_projects_actions__WEBPACK_IMPORTED_MODULE_3__["ProjectsActionTypes"].CreateProject), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((action) => {
            this.projectsFacadeService.callbacks.success();
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["concat"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])(new _actions_projects_actions__WEBPACK_IMPORTED_MODULE_3__["TakeSnapshotAction"]()), Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])(new _actions_projects_actions__WEBPACK_IMPORTED_MODULE_3__["CreateProjectSuccessAction"](action.payload)), this.projectsService.createProject(action.payload)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(() => rxjs__WEBPACK_IMPORTED_MODULE_7__["EMPTY"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(3), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(error => {
...
ProjectsEffects.ctorParameters = () => [
...
let ProjectsStoreModule = class ProjectsStoreModule {
};
...
const initialState = Object.assign({}, initialStateCore, { snapshot: initialStateCore });
...
const updateCurrentProject = (state, project) => {
...
const createProject = (state, createdProject) => {
    state.projects.push(createdProject);
    return state.projects;
};
const deleteProject = (state, deletedProject) => {
...
const projectsFeatureSelector = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createFeatureSelector"])(_reducers_projects_reducer__WEBPACK_IMPORTED_MODULE_2__["projectsFeatureKey"]);
const getSelectedProjectsIds = (state) => state.selectedProjectsIds;
const getProjects = (state) => state.projects;
const getCurrentProject = (state) => state.currentProject;
const selectSelectedProjectsIds = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(projectsFeatureSelector, getSelectedProjectsIds);
const selectProjects = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(projectsFeatureSelector, getProjects);
const selectCurrentProject = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(projectsFeatureSelector, getCurrentProject);
...
ProjectsFacadeService.ctorParameters = () => [
